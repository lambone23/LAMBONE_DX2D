...
namespace yha
{
	...
	CGameObject* CCommonObjects::mUI_PositionRuler_H		= nullptr;
	CGameObject* CCommonObjects::mUI_PositionRuler_V		= nullptr;

	CGameObject* CCommonObjects::mUI_SignX					= nullptr;
	CGameObject* CCommonObjects::mUI_Sunflower				= nullptr;
	CGameObject* CCommonObjects::mUI_WallNut				= nullptr;
	CGameObject* CCommonObjects::mUI_PeaShooter				= nullptr;
	CGameObject* CCommonObjects::mUI_Chomper				= nullptr;
	CGameObject* CCommonObjects::mUI_Jalapeno				= nullptr;
	CGameObject* CCommonObjects::mUI_CherryBomb				= nullptr;
	...
	void CCommonObjects::FnReleaseALL()
	{
		...
		object::FnDestroy(mUI_PositionRuler_H);
		object::FnDestroy(mUI_PositionRuler_V);
		object::FnDestroy(mUI_SignX);
		object::FnDestroy(mUI_Sunflower);
		object::FnDestroy(mUI_WallNut);
		object::FnDestroy(mUI_PeaShooter);
		object::FnDestroy(mUI_Chomper);
		object::FnDestroy(mUI_Jalapeno);
		object::FnDestroy(mUI_CherryBomb);
	}
...
#pragma region Resource_UI_Play
		...
		// UI_PositionRuler_H
		mUI_PositionRuler_H = object::FnInstantiate<CGameObject>(POSITION_CLEAR, eLayerType::UI);
		mr = mUI_PositionRuler_H->FnAddComponent<CMeshRenderer>();
		mr->FnSetMesh(CResources::FnFind<CMesh>(L"RectMesh"));
		mr->FnSetMaterial(CResources::FnFind<CMaterial>(L"UI_PositionRuler_H"));
		mUI_PositionRuler_H->FnGetComponent<CTransform>()->FnSetScale(Vector3(5.7f, (113.f * 5.7f) / 1020.f, 0.f));

		// UI_PositionRuler_V
		mUI_PositionRuler_V = object::FnInstantiate<CGameObject>(POSITION_CLEAR, eLayerType::UI);
		mr = mUI_PositionRuler_V->FnAddComponent<CMeshRenderer>();
		mr->FnSetMesh(CResources::FnFind<CMesh>(L"RectMesh"));
		mr->FnSetMaterial(CResources::FnFind<CMaterial>(L"UI_PositionRuler_V"));
		mUI_PositionRuler_V->FnGetComponent<CTransform>()->FnSetScale(Vector3(0.6f, (114.f * 19.f) / 569.f, 0.f));

		// UI_Sign_X
		mUI_SignX = object::FnInstantiate<CGameObject>(POSITION_CLEAR, eLayerType::UI);
		mr = mUI_SignX->FnAddComponent<CMeshRenderer>();
		mr->FnSetMesh(CResources::FnFind<CMesh>(L"RectMesh"));
		mr->FnSetMaterial(CResources::FnFind<CMaterial>(L"UI_Sign_X"));
		mUI_SignX->FnGetComponent<CTransform>()->FnSetScale(Vector3(0.5f, (157.f * 0.5f) / 159.f, 0.f));

		// UI_SunFlower
		mUI_Sunflower = object::FnInstantiate<CGameObject>(POSITION_CLEAR, eLayerType::UI);
		mr = mUI_Sunflower->FnAddComponent<CMeshRenderer>();
		mr->FnSetMesh(CResources::FnFind<CMesh>(L"RectMesh"));
		mr->FnSetMaterial(CResources::FnFind<CMaterial>(L"UI_SunFlower0"));
		mUI_Sunflower->FnGetComponent<CTransform>()->FnSetScale(Vector3(0.5f, (74.f * 0.5f) / 73.f, 0.f));

		// UI_WallNut
		mUI_WallNut = object::FnInstantiate<CGameObject>(POSITION_CLEAR, eLayerType::UI);
		mr = mUI_WallNut->FnAddComponent<CMeshRenderer>();
		mr->FnSetMesh(CResources::FnFind<CMesh>(L"RectMesh"));
		mr->FnSetMaterial(CResources::FnFind<CMaterial>(L"UI_WallNut0"));
		mUI_WallNut->FnGetComponent<CTransform>()->FnSetScale(Vector3(0.5f, (74.f * 0.5f) / 73.f, 0.f));

		// UI_PeaShooter
		mUI_PeaShooter = object::FnInstantiate<CGameObject>(POSITION_CLEAR, eLayerType::UI);
		mr = mUI_PeaShooter->FnAddComponent<CMeshRenderer>();
		mr->FnSetMesh(CResources::FnFind<CMesh>(L"RectMesh"));
		mr->FnSetMaterial(CResources::FnFind<CMaterial>(L"UI_PeaShooter0"));
		mUI_PeaShooter->FnGetComponent<CTransform>()->FnSetScale(Vector3(0.5f, (71.f * 0.5f) / 71.f, 0.f));

		// UI_Chomper
		mUI_Chomper = object::FnInstantiate<CGameObject>(POSITION_CLEAR, eLayerType::UI);
		mr = mUI_Chomper->FnAddComponent<CMeshRenderer>();
		mr->FnSetMesh(CResources::FnFind<CMesh>(L"RectMesh"));
		mr->FnSetMaterial(CResources::FnFind<CMaterial>(L"UI_Chomper0"));
		mUI_Chomper->FnGetComponent<CTransform>()->FnSetScale(Vector3(1.f, (114.f * 1.f) / 130.f, 0.f));

		// UI_Jalapeno
		mUI_Jalapeno = object::FnInstantiate<CGameObject>(POSITION_CLEAR, eLayerType::UI);
		mr = mUI_Jalapeno->FnAddComponent<CMeshRenderer>();
		mr->FnSetMesh(CResources::FnFind<CMesh>(L"RectMesh"));
		mr->FnSetMaterial(CResources::FnFind<CMaterial>(L"UI_Jalapeno0"));
		mUI_Jalapeno->FnGetComponent<CTransform>()->FnSetScale(Vector3(0.5f, (89.f * 0.5f) / 68.f, 0.f));

		// UI_CherryBomb
		mUI_CherryBomb = object::FnInstantiate<CGameObject>(POSITION_CLEAR, eLayerType::UI);
		mr = mUI_CherryBomb->FnAddComponent<CMeshRenderer>();
		mr->FnSetMesh(CResources::FnFind<CMesh>(L"RectMesh"));
		mr->FnSetMaterial(CResources::FnFind<CMaterial>(L"UI_CherryBomb0"));
		mUI_CherryBomb->FnGetComponent<CTransform>()->FnSetScale(Vector3(0.8f, (81.f * 0.8f) / 112.f, 0.f));
#pragma endregion
