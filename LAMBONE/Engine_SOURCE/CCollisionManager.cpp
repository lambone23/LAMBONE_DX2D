...
//namespace yha
//{
//	WORD CCollisionMgr::mMatrix[(UINT)EGameObjectType::End] = {};
//	std::map<UINT64, bool> CCollisionMgr::mCollisionMap;
//	void CCollisionMgr::Update()
//	{
//		CScene* Scene = CSceneMgr::FnGetActiveScene();
//
//		for (UINT Row = 0; Row < (UINT)EGameObjectType::End; Row++)
//		{
//			for (UINT Col = 0; Col < (UINT)EGameObjectType::End; Col++)
//			{
//				if (mMatrix[Row] & (1 << Col))
//				{
//					FnLayerCollision(Scene, (EGameObjectType)Row, (EGameObjectType)Col);
//				}
//			}
//		}
//	}
//
//	void CCollisionMgr::FnLayerCollision(CScene* Scene, EGameObjectType Left, EGameObjectType Right)
//	{
...
//	}
//
//	void CCollisionMgr::FnColliderCollision(CCollider* LeftCol, CCollider* RightCol, EGameObjectType Left, EGameObjectType Right)
//	{
