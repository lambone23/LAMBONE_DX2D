...
namespace renderer
{
	...
	//yha::graphics::CConstantBuffer* constantBuffer = nullptr;
	yha::graphics::CConstantBuffer* constantBuffers[(UINT)eCBType::End];
	...
	void FnLoadBuffer()
	{
		...
		//constantBuffer = new CConstantBuffer(eCBType::Transform);
		//constantBuffer->FnCreate(sizeof(Vector4));
		constantBuffers[(UINT)eCBType::Transform] = new yha::graphics::CConstantBuffer(eCBType::Transform);
		constantBuffers[(UINT)eCBType::Transform]->FnCreate(sizeof(Vertex));
